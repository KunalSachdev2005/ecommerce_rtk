...
import { removeItemFromCart, clearCart, icreaseItemQuantity, decreaseItemQuantity } from './CartSlice'; 
...
const ShoppingCart = () => {
    ...
    const handleIncreaseQuantity = (itemId) => {
        dispatch(icreaseItemQuantity(itemId));
    };
  ...
  return (
    ...
    <div>{totalAmount ? <div>The total amont is {totalAmount}</div> : ''}</div>
